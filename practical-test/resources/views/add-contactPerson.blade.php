...
<body>
    ...
    <div class="py-10">
        <h2 class="text-4xl text-center font-bold mb-4 text-blue-500">Add New Contact Person</h2>
        <form action="{{ route('submitContactPerson') }}" method="POST"
            class="max-w-md mx-auto mt-8 p-4 border rounded-lg shadow-lg">
            @csrf
            <div class="mb-4">
                <label for="name" class="block text-gray-700">Contact Person Name:</label>
            ...
            <div class="mb-4">
                <label for="type" class="block text-gray-700">Customer:</label>
